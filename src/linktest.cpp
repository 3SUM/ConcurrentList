...
int main(int argc, char *argv[]) {
    ...
    cout << bars << endl
         << bold << "Coarse Grained Linked List" << unbold << unbold << endl;
    ...
    cout << bars << endl
         << bold << "Fine Grained Linked List" << unbold << unbold << endl;
    ...
    cout << bars << endl
         << bold << "Optimistic Synchronization Linked List" << unbold << unbold << endl;
    ...
    cout << bars << endl
         << bold << "Lazy Synchronization Linked List" << unbold << unbold << endl;
